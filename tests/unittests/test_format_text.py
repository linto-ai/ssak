...
class TestFormatTextArabic(Test):
    ...
    def test_biggest_numbers(self):
        ...
        self.assertEqual(
            ...
            ' سالب مائة و ثلاثة و عشرون سكستيليونا و أربعمائة و ستة و خمسون كوينتليونا و سبعمائةتسعة و ثمانون كوادريليونا و مائة و ثلاثة و عشرون تريليونا و أربعمائة و ستة و خمسون مليارا و سبعمائةواحد و تسعون مليونا و سبعمائةأربعون ألفا و أربعمائة و ستة عشر ' 
        )
...
class TestFormatTextRu(Test):
    ...
    def test_format_digits(self):
        self.assertEqual(
            format_text_ru("2 января et 02 января et 02 января 2001 et 2001 г"),
            "второго января et второго января et второго января две тысячи первого et две тысячи первого года"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            format_text_ru("в четверг 4-го числа в 4 с 1/4 часа регулировщик регулировал в Лигурии, но 33%  и 6,5 кг лавировали"),
            "В четверг четвертого числа в четыре с четвертью часа  регулировщик регулировал в Лигурии, но тридцать три процента и шесть с половиной килограмм лавировали"
        )
        self.assertEqual(
            format_text_ru(""),
            ""
