...
class KaldiDataset:
    ...
    Main methods:
        ...
        normalize_dataset(apply_text_normalization): Normalize the texts in the dataset using the format_text_latin function from sak.utils.text_latin
    ...
    def normalize_dataset(self, apply_text_normalization=True):
        """
        Normalize the texts in the dataset using the format_text_latin function from sak.utils.text_latin
