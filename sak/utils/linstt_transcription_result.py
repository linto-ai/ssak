...
# This is a copy of https://github.com/linto-ai/linto-platform-transcription-service/blob/master/transcriptionservice/transcription/transcription_result.py
import json
