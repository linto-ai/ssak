...
from sak.utils.env import use_gpu # handle option --gpus (and set environment variables at the beginning)
from sak.utils.text import (
    format_special_characters,
    remove_special_words,
    remove_special_characters,
)
from sak.utils.monitoring import vram_usage, get_num_gpus, tic, toc
from sak.utils.dataset import kaldi_folder_to_dataset, process_dataset
from sak.utils.augment import SpeechAugment
from sak.utils.wer import compute_wer
from sak.utils.train_utils import dataset_pseudos, args_to_str
...
if __name__ == "__main__":
    ...
    if args.text_augmentation:
        if language == "ar":
            ...
            from sak.utils.text_ar import \
                ...
                normalize_punct
            from sak.utils.text_utils import remove_punctuations
    ...
    if language == "ar":
        ...
        from sak.utils.text_ar import remove_arabic_diacritics
