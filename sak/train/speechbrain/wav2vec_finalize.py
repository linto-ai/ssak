...
from sak.infer.speechbrain_infer import speechbrain_load_model
from sak.utils.yaml_utils import copy_yaml_fields, make_yaml_overrides
...
wav2vec2: !new:speechbrain.lobes.models.huggingface_wav2vec.HuggingFaceWav2Vec2
    ...
    save_path: !apply:sak.utils.misc.get_cache_dir [ speechbrain/wav2vec2_checkpoint ] # ~/.cache/speechbrain/wav2vec2_checkpoint
""")
