...
def convert_dataset(kaldi_input_dataset, output_dir, new_audio_folder=None, check_audio=False):
    ...
    if check_audio:
        ...
        kaldi_dataset.normalize_audios(os.path.join(new_audio_folder, kaldi_dataset.name), target_sample_rate=16000, target_extension=None) # target extension is maybe not needed
